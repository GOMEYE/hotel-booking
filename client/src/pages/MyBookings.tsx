...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 mb:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="MY Bookings"
        subTitle="Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor ipsa minus nam molestiae voluptatem neque, odit, quo aliquam ab, placeat aut sapiente"
        align="left"
      />
      ...
      <div className="max-w-6xl mt-8 w-full text-gray-800 ">
        <div className="hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3">
          ...
          <div className="w-1/3">Data & Times</div>
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                ...
                <div className="fkex items-center gap-1 text-sm text-gray-500">
